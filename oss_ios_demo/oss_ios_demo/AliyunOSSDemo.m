...
NSString * const AccessKey = @"LTAIivce210f56R6";
NSString * const SecretKey = @"0MSklPzMlBdM90sCuQ4PyQw37SEwaN";
NSString * const endPoint = @"http://buck-video.oss-cn-hangzhou.aliyuncs.com";
...
- (void)initOSSClient {
    ...
    id<OSSCredentialProvider> credential2 = [[OSSFederationCredentialProvider alloc] initWithFederationTokenGetter:^OSSFederationToken * {
        NSURL * url = [NSURL URLWithString:@"http://tspigdemo.oss-cn-hangzhou.aliyuncs.com"];
...
- (void)copyObjectAsync {
    ...
    copy.bucketName = @"iOS-test"; // 复制到哪个bucket
    copy.objectKey = @"file_copy_to"; // 复制为哪个object
    copy.sourceCopyFrom = [NSString stringWithFormat:@"/%@/%@", @"iOS-test", @"file1m"]; // 从哪里复制
...
- (void)multipartUpload {
    ...
    NSString * uploadToBucket = @"iOS-test";
