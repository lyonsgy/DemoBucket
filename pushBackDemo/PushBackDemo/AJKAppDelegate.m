...
//    MVC.indexNum = 0;
//    PushBackNavigationController *nav = [[PushBackNavigationController alloc]initWithRootViewController:vc];

    NPMainPageViewController *vc = [[NPMainPageViewController alloc]init];
